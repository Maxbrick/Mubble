...
public class MubbleSoundTypes {
	...
	public static final SoundType DREAM_BLOCK = new SoundType(1.0F, 1.0F, MubbleSounds.BLOCK_DREAM_BLOCK_BREAK, MubbleSounds.BLOCK_DREAM_BLOCK_STEP, MubbleSounds.BLOCK_DREAM_BLOCK_PLACE, MubbleSounds.BLOCK_DREAM_BLOCK_HIT, MubbleSounds.BLOCK_DREAM_BLOCK_FALL);
}