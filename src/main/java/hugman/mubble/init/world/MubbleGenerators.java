	...
	public static void registerTrees() {
		for(Biome biome : ForgeRegistries.BIOMES) {
			if(biome.getCategory().equals(Category.DESERT)) {
				biome.addFeature(GenerationStage.Decoration.VEGETAL_DECORATION, Feature.field_227246_s_.configure(MubbleFeatureConfigs.PALM_TREE_CONFIG).createDecoratedFeature(Placement.COUNT_EXTRA_HEIGHTMAP.configure(new AtSurfaceWithExtraConfig(0, 0.12F, 1))));
			}
		}
	}
