...
public class CustomTNTBlock extends Block {
	...
	public void onExplosionDestroy(World world, BlockPos pos, Explosion explosion) {
		if(!world.isRemote) {
			CustomTNTEntity tntentity = new CustomTNTEntity(this.getDefaultState(), world, (float) pos.getX() + 0.5F, pos.getY(), (float) pos.getZ() + 0.5F, fuse, strenght, explosion.getExplosivePlacedBy());
