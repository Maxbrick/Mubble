...
{
	private DefaultedList<ItemStack> inventory = DefaultedList.ofSize(this.getInvSize(), ItemStack.EMPTY);
	...
	{
		this.scheduleTick();
		return Inventories.splitStack(this.inventory, index, count);
	}
