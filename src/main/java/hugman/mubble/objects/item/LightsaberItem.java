...
public class LightsaberItem extends SwordItem {
	...
	public void onPullOut(Entity entity, World world) {
		world.playMovingSound(null, entity, MubbleSounds.ITEM_LIGHTSABER_PULL_OUT, SoundCategory.PLAYERS, 1.0F, 1.0F);
	}

	public void onPullIn(Entity entity, World world) {
		world.playMovingSound(null, entity, MubbleSounds.ITEM_LIGHTSABER_PULL_IN, SoundCategory.PLAYERS, 1.0F, 1.0F);
