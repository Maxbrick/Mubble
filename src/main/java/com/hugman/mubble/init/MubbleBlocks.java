...
public class MubbleBlocks extends MubblePack {
	/* MUBBLE */
	public static final Block BLUE_CHRISTMAS_BAUBLE = register(new BlockCreator.Builder("blue_christmas_bauble", new Block(Settings.CHRISTMAS_BAUBLE.mapColor(MapColor.BLUE_TERRACOTTA))).itemGroup(ItemGroup.DECORATIONS));
	public static final Block LIGHT_BLUE_CHRISTMAS_BAUBLE = register(new BlockCreator.Builder("light_blue_christmas_bauble", new Block(Settings.CHRISTMAS_BAUBLE.mapColor(MapColor.LIGHT_BLUE_TERRACOTTA))).itemGroup(ItemGroup.DECORATIONS));
	public static final Block PURPLE_CHRISTMAS_BAUBLE = register(new BlockCreator.Builder("purple_christmas_bauble", new Block(Settings.CHRISTMAS_BAUBLE.mapColor(MapColor.PURPLE_TERRACOTTA))).itemGroup(ItemGroup.DECORATIONS));
	public static final Block MAGENTA_CHRISTMAS_BAUBLE = register(new BlockCreator.Builder("magenta_christmas_bauble", new Block(Settings.CHRISTMAS_BAUBLE.mapColor(MapColor.MAGENTA_TERRACOTTA))).itemGroup(ItemGroup.DECORATIONS));
	public static final Block PINK_CHRISTMAS_BAUBLE = register(new BlockCreator.Builder("pink_christmas_bauble", new Block(Settings.CHRISTMAS_BAUBLE.mapColor(MapColor.PINK_TERRACOTTA))).itemGroup(ItemGroup.DECORATIONS));
	public static final Block RED_CHRISTMAS_BAUBLE = register(new BlockCreator.Builder("red_christmas_bauble", new Block(Settings.CHRISTMAS_BAUBLE.mapColor(MapColor.RED_TERRACOTTA))).itemGroup(ItemGroup.DECORATIONS));
	public static final Block ORANGE_CHRISTMAS_BAUBLE = register(new BlockCreator.Builder("orange_christmas_bauble", new Block(Settings.CHRISTMAS_BAUBLE.mapColor(MapColor.ORANGE_TERRACOTTA))).itemGroup(ItemGroup.DECORATIONS));
	public static final Block YELLOW_CHRISTMAS_BAUBLE = register(new BlockCreator.Builder("yellow_christmas_bauble", new Block(Settings.CHRISTMAS_BAUBLE.mapColor(MapColor.YELLOW_TERRACOTTA))).itemGroup(ItemGroup.DECORATIONS));
	public static final Block GREEN_CHRISTMAS_BAUBLE = register(new BlockCreator.Builder("green_christmas_bauble", new Block(Settings.CHRISTMAS_BAUBLE.mapColor(MapColor.GREEN_TERRACOTTA))).itemGroup(ItemGroup.DECORATIONS));
	public static final Block WHITE_CHRISTMAS_BAUBLE = register(new BlockCreator.Builder("white_christmas_bauble", new Block(Settings.CHRISTMAS_BAUBLE.mapColor(MapColor.WHITE_TERRACOTTA))).itemGroup(ItemGroup.DECORATIONS));
	public static final Block RED_SHINY_GARLAND = register(new BlockCreator.Builder("red_shiny_garland", new GarlandBlock(FabricBlockSettings.of(Material.LEAVES, MapColor.RED).hardness(0.2F).sounds(BlockSoundGroup.GRASS))).itemGroup(ItemGroup.DECORATIONS).flammability(30, 60).render(BlockCreator.Render.CUTOUT_MIPPED));
	public static final Block SILVER_SHINY_GARLAND = register(new BlockCreator.Builder("silver_shiny_garland", new GarlandBlock(FabricBlockSettings.of(Material.LEAVES, MapColor.CLAY).hardness(0.2F).sounds(BlockSoundGroup.GRASS))).itemGroup(ItemGroup.DECORATIONS).flammability(30, 60).render(BlockCreator.Render.CUTOUT_MIPPED));
	public static final Block GOLD_SHINY_GARLAND = register(new BlockCreator.Builder("gold_shiny_garland", new GarlandBlock(FabricBlockSettings.of(Material.LEAVES, MapColor.GOLD).hardness(0.2F).sounds(BlockSoundGroup.GRASS))).itemGroup(ItemGroup.DECORATIONS).flammability(30, 60).render(BlockCreator.Render.CUTOUT_MIPPED));
	public static final Block WHITE_PRESENT = register(new BlockCreator.Builder("white_present", new PresentBlock(FabricBlockSettings.of(Material.WOOD, MapColor.WHITE_TERRACOTTA).hardness(0.8F).sounds(BlockSoundGroup.WOOD))).itemGroup(ItemGroup.DECORATIONS).flammability(60, 60).render(BlockCreator.Render.CUTOUT_MIPPED));
	public static final Block BLACK_PRESENT = register(new BlockCreator.Builder("black_present", new PresentBlock(FabricBlockSettings.of(Material.WOOD, MapColor.BLACK_TERRACOTTA).hardness(0.8F).sounds(BlockSoundGroup.WOOD))).itemGroup(ItemGroup.DECORATIONS).flammability(60, 60).render(BlockCreator.Render.CUTOUT_MIPPED));
	public static final Block BLUE_PRESENT = register(new BlockCreator.Builder("blue_present", new PresentBlock(FabricBlockSettings.of(Material.WOOD, MapColor.BLUE_TERRACOTTA).hardness(0.8F).sounds(BlockSoundGroup.WOOD))).itemGroup(ItemGroup.DECORATIONS).flammability(60, 60).render(BlockCreator.Render.CUTOUT_MIPPED));
	public static final Block GREEN_PRESENT = register(new BlockCreator.Builder("green_present", new PresentBlock(FabricBlockSettings.of(Material.WOOD, MapColor.GREEN_TERRACOTTA).hardness(0.8F).sounds(BlockSoundGroup.WOOD))).itemGroup(ItemGroup.DECORATIONS).flammability(60, 60).render(BlockCreator.Render.CUTOUT_MIPPED));
	public static final Block YELLOW_PRESENT = register(new BlockCreator.Builder("yellow_present", new PresentBlock(FabricBlockSettings.of(Material.WOOD, MapColor.YELLOW_TERRACOTTA).hardness(0.8F).sounds(BlockSoundGroup.WOOD))).itemGroup(ItemGroup.DECORATIONS).flammability(60, 60).render(BlockCreator.Render.CUTOUT_MIPPED));
	public static final Block RED_PRESENT = register(new BlockCreator.Builder("red_present", new PresentBlock(FabricBlockSettings.of(Material.WOOD, MapColor.RED_TERRACOTTA).hardness(0.8F).sounds(BlockSoundGroup.WOOD))).itemGroup(ItemGroup.DECORATIONS).flammability(60, 60).render(BlockCreator.Render.CUTOUT_MIPPED));
	public static final Block PURPLE_PRESENT = register(new BlockCreator.Builder("purple_present", new PresentBlock(FabricBlockSettings.of(Material.WOOD, MapColor.PURPLE_TERRACOTTA).hardness(0.8F).sounds(BlockSoundGroup.WOOD))).itemGroup(ItemGroup.DECORATIONS).flammability(60, 60).render(BlockCreator.Render.CUTOUT_MIPPED));
	public static final Block GOLDEN_PRESENT = register(new BlockCreator.Builder("golden_present", new PresentBlock(FabricBlockSettings.of(Material.WOOD, MapColor.GOLD).hardness(0.8F).sounds(BlockSoundGroup.WOOD))).itemGroup(ItemGroup.DECORATIONS).flammability(60, 60).render(BlockCreator.Render.CUTOUT_MIPPED));
	public static final BlockEntityType<PresentBlockEntity> PRESENT_ENTITY = register(new BlockEntityCreator.Builder<>("present", FabricBlockEntityTypeBuilder.create(PresentBlockEntity::new, MubbleBlocks.WHITE_PRESENT, MubbleBlocks.BLACK_PRESENT, MubbleBlocks.BLUE_PRESENT, MubbleBlocks.GREEN_PRESENT, MubbleBlocks.YELLOW_PRESENT, MubbleBlocks.RED_PRESENT, MubbleBlocks.PURPLE_PRESENT, MubbleBlocks.GOLDEN_PRESENT)));
	...
	public static final BlockEntityType<DispenserBlockEntity> PLACER_ENTITY = register(new BlockEntityCreator.Builder<>("placer", FabricBlockEntityTypeBuilder.create(PlacerBlockEntity::new, MubbleBlocks.PLACER)));
	...
	public static final Block LIGHT_BLOCK = register(new BlockCreator.Builder("light_block", new Block(FabricBlockSettings.of(Material.STONE, MapColor.STONE).strength(1.5F, 6.0F).lightLevel(15))));
	...
	/* KIRBY */
	public static final Block KIRBY_BLOCK = register(new BlockCreator.Builder("kirby_block", new DirectionalBlock(FabricBlockSettings.of(Material.ORGANIC_PRODUCT, MapColor.PINK).hardness(0.5F).sounds(BlockSoundGroup.WOOL))).itemGroup(ItemGroup.DECORATIONS));
	/* TETRIS */
	public static final Block WHITE_TETRIS_BLOCK = register(new BlockCreator.Builder("white", MubbleBlockGetter.TETRIS_BLOCK, Settings.TETRIS_BLOCK.mapColor(DyeColor.WHITE)));
	public static final Block LIGHT_GRAY_TETRIS_BLOCK = register(new BlockCreator.Builder("light_gray", MubbleBlockGetter.TETRIS_BLOCK, Settings.TETRIS_BLOCK.mapColor(DyeColor.LIGHT_GRAY)));
	public static final Block GRAY_TETRIS_BLOCK = register(new BlockCreator.Builder("gray", MubbleBlockGetter.TETRIS_BLOCK, Settings.TETRIS_BLOCK.mapColor(DyeColor.GRAY)));
	public static final Block BLACK_TETRIS_BLOCK = register(new BlockCreator.Builder("black", MubbleBlockGetter.TETRIS_BLOCK, Settings.TETRIS_BLOCK.mapColor(DyeColor.BLACK)));
	public static final Block BROWN_TETRIS_BLOCK = register(new BlockCreator.Builder("brown", MubbleBlockGetter.TETRIS_BLOCK, Settings.TETRIS_BLOCK.mapColor(DyeColor.BROWN)));
	public static final Block RED_TETRIS_BLOCK = register(new BlockCreator.Builder("red", MubbleBlockGetter.TETRIS_BLOCK, Settings.TETRIS_BLOCK.mapColor(DyeColor.RED)));
	public static final Block ORANGE_TETRIS_BLOCK = register(new BlockCreator.Builder("orange", MubbleBlockGetter.TETRIS_BLOCK, Settings.TETRIS_BLOCK.mapColor(DyeColor.ORANGE)));
	public static final Block YELLOW_TETRIS_BLOCK = register(new BlockCreator.Builder("yellow", MubbleBlockGetter.TETRIS_BLOCK, Settings.TETRIS_BLOCK.mapColor(DyeColor.YELLOW)));
	public static final Block LIME_TETRIS_BLOCK = register(new BlockCreator.Builder("lime", MubbleBlockGetter.TETRIS_BLOCK, Settings.TETRIS_BLOCK.mapColor(DyeColor.LIME)));
	public static final Block GREEN_TETRIS_BLOCK = register(new BlockCreator.Builder("green", MubbleBlockGetter.TETRIS_BLOCK, Settings.TETRIS_BLOCK.mapColor(DyeColor.GREEN)));
	public static final Block CYAN_TETRIS_BLOCK = register(new BlockCreator.Builder("cyan", MubbleBlockGetter.TETRIS_BLOCK, Settings.TETRIS_BLOCK.mapColor(DyeColor.CYAN)));
	public static final Block LIGHT_BLUE_TETRIS_BLOCK = register(new BlockCreator.Builder("light_blue", MubbleBlockGetter.TETRIS_BLOCK, Settings.TETRIS_BLOCK.mapColor(DyeColor.LIGHT_BLUE)));
	public static final Block BLUE_TETRIS_BLOCK = register(new BlockCreator.Builder("blue", MubbleBlockGetter.TETRIS_BLOCK, Settings.TETRIS_BLOCK.mapColor(DyeColor.BLUE)));
	public static final Block PURPLE_TETRIS_BLOCK = register(new BlockCreator.Builder("purple", MubbleBlockGetter.TETRIS_BLOCK, Settings.TETRIS_BLOCK.mapColor(DyeColor.PURPLE)));
	public static final Block MAGENTA_TETRIS_BLOCK = register(new BlockCreator.Builder("magenta", MubbleBlockGetter.TETRIS_BLOCK, Settings.TETRIS_BLOCK.mapColor(DyeColor.MAGENTA)));
	public static final Block PINK_TETRIS_BLOCK = register(new BlockCreator.Builder("pink", MubbleBlockGetter.TETRIS_BLOCK, Settings.TETRIS_BLOCK.mapColor(DyeColor.PINK)));
	...
	public static final Block WHITE_CANDY_CANE_PILLAR = register(new BlockCreator.Builder("white_candy_cane_pillar", new PillarBlock(Settings.CANDY_CANE_BLOCK.mapColor(DyeColor.WHITE))).itemGroup(ItemGroup.DECORATIONS).flammability(5, 10));
	public static final Block LIGHT_GRAY_CANDY_CANE_PILLAR = register(new BlockCreator.Builder("light_gray_candy_cane_pillar", new PillarBlock(Settings.CANDY_CANE_BLOCK.mapColor(DyeColor.LIGHT_GRAY))).itemGroup(ItemGroup.DECORATIONS).flammability(5, 10));
	public static final Block GRAY_CANDY_CANE_PILLAR = register(new BlockCreator.Builder("gray_candy_cane_pillar", new PillarBlock(Settings.CANDY_CANE_BLOCK.mapColor(DyeColor.GRAY))).itemGroup(ItemGroup.DECORATIONS).flammability(5, 10));
	public static final Block BLACK_CANDY_CANE_PILLAR = register(new BlockCreator.Builder("black_candy_cane_pillar", new PillarBlock(Settings.CANDY_CANE_BLOCK.mapColor(DyeColor.BLACK))).itemGroup(ItemGroup.DECORATIONS).flammability(5, 10));
	public static final Block BROWN_CANDY_CANE_PILLAR = register(new BlockCreator.Builder("brown_candy_cane_pillar", new PillarBlock(Settings.CANDY_CANE_BLOCK.mapColor(DyeColor.BROWN))).itemGroup(ItemGroup.DECORATIONS).flammability(5, 10));
	public static final Block RED_CANDY_CANE_PILLAR = register(new BlockCreator.Builder("red_candy_cane_pillar", new PillarBlock(Settings.CANDY_CANE_BLOCK.mapColor(DyeColor.RED))).itemGroup(ItemGroup.DECORATIONS).flammability(5, 10));
	public static final Block ORANGE_CANDY_CANE_PILLAR = register(new BlockCreator.Builder("orange_candy_cane_pillar", new PillarBlock(Settings.CANDY_CANE_BLOCK.mapColor(DyeColor.ORANGE))).itemGroup(ItemGroup.DECORATIONS).flammability(5, 10));
	public static final Block YELLOW_CANDY_CANE_PILLAR = register(new BlockCreator.Builder("yellow_candy_cane_pillar", new PillarBlock(Settings.CANDY_CANE_BLOCK.mapColor(DyeColor.YELLOW))).itemGroup(ItemGroup.DECORATIONS).flammability(5, 10));
	public static final Block LIME_CANDY_CANE_PILLAR = register(new BlockCreator.Builder("lime_candy_cane_pillar", new PillarBlock(Settings.CANDY_CANE_BLOCK.mapColor(DyeColor.LIME))).itemGroup(ItemGroup.DECORATIONS).flammability(5, 10));
	public static final Block GREEN_CANDY_CANE_PILLAR = register(new BlockCreator.Builder("green_candy_cane_pillar", new PillarBlock(Settings.CANDY_CANE_BLOCK.mapColor(DyeColor.GREEN))).itemGroup(ItemGroup.DECORATIONS).flammability(5, 10));
	public static final Block CYAN_CANDY_CANE_PILLAR = register(new BlockCreator.Builder("cyan_candy_cane_pillar", new PillarBlock(Settings.CANDY_CANE_BLOCK.mapColor(DyeColor.CYAN))).itemGroup(ItemGroup.DECORATIONS).flammability(5, 10));
	public static final Block LIGHT_BLUE_CANDY_CANE_PILLAR = register(new BlockCreator.Builder("light_blue_candy_cane_pillar", new PillarBlock(Settings.CANDY_CANE_BLOCK.mapColor(DyeColor.LIGHT_BLUE))).itemGroup(ItemGroup.DECORATIONS).flammability(5, 10));
	public static final Block BLUE_CANDY_CANE_PILLAR = register(new BlockCreator.Builder("blue_candy_cane_pillar", new PillarBlock(Settings.CANDY_CANE_BLOCK.mapColor(DyeColor.BLUE))).itemGroup(ItemGroup.DECORATIONS).flammability(5, 10));
	public static final Block PURPLE_CANDY_CANE_PILLAR = register(new BlockCreator.Builder("purple_candy_cane_pillar", new PillarBlock(Settings.CANDY_CANE_BLOCK.mapColor(DyeColor.PURPLE))).itemGroup(ItemGroup.DECORATIONS).flammability(5, 10));
	public static final Block MAGENTA_CANDY_CANE_PILLAR = register(new BlockCreator.Builder("magenta_candy_cane_pillar", new PillarBlock(Settings.CANDY_CANE_BLOCK.mapColor(DyeColor.MAGENTA))).itemGroup(ItemGroup.DECORATIONS).flammability(5, 10));
	public static final Block PINK_CANDY_CANE_PILLAR = register(new BlockCreator.Builder("pink_candy_cane_pillar", new PillarBlock(Settings.CANDY_CANE_BLOCK.mapColor(DyeColor.PINK))).itemGroup(ItemGroup.DECORATIONS).flammability(5, 10));
	/* SONIC */
	...
	public static final WoodPack PRESS_GARDEN_WOOD = register(new WoodPack.Builder("press_garden", MapColor.CRIMSON_NYLIUM, MapColor.CRIMSON_STEM, MapColor.WARPED_HYPHAE, false));
	...
	/* UNDERTALE / DELTARUNE */
	public static final NormalWoodPack SCARLET_WOOD = register(new NormalWoodPack.Builder("scarlet", new ScarletSaplingGenerator(), MapColor.CRIMSON_NYLIUM, MapColor.CRIMSON_STEM, MapColor.WARPED_HYPHAE));
	public static final PottedPlantPack SCARLET_MUSHROOM = register(new PottedPlantPack.Builder(new BlockCreator.Builder("scarlet_mushroom", new MushroomPlantBlock(FabricBlockSettings.of(Material.PLANT).noCollision().hardness(0.0F).sounds(BlockSoundGroup.GRASS).luminance(7), () -> MubbleConfiguredFeatures.HUGE_SCARLET_TREE)).itemGroup(ItemGroup.DECORATIONS).render(BlockCreator.Render.CUTOUT)));
	...
	public static final Block ELDER_PEBBLES = register(new BlockCreator.Builder("elder_pebbles", new Block(FabricBlockSettings.of(Material.STONE, MapColor.RED).strength(2.0F, 6.0F).lightLevel(5))).itemGroup(ItemGroup.BUILDING_BLOCKS));
	...
	public static final Block TURQUOISE_PUYO = register(new BlockCreator.Builder("turquoise_puyo", new PuyoBlock(FabricBlockSettings.of(Material.ORGANIC_PRODUCT, MapColor.EMERALD).slipperiness(0.8F).sounds(BlockSoundGroup.SLIME))).noItem());
	...
	public static final Block POINT_PUYO = register(new BlockCreator.Builder("point_puyo", new DirectionalBlock(FabricBlockSettings.of(Material.STONE, MapColor.STONE).strength(1.5F, 6.0F).lightLevel(10))).noItem());
